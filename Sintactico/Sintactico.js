...
function valida_where(posicion) {
    ...
    // Agrega lógica para validar la condición WHERE
    // Verifica si el siguiente token es '=' y el siguiente es '1'
...
function valida_order_by(posicion) {
    ...
    // Agrega lógica adicional para validar la cláusula ORDER BY si es necesario
    return posicion;
}

function valida_limit(posicion) {
    console.log(posicion + " -> LIMIT : " + LIMIT);
    // Agrega lógica adicional para validar la cláusula LIMIT si es necesario
    return posicion;
}

function valida_group_by(posicion) {
    console.log(posicion + " -> GROUP BY : " + GROUP_BY);
    // Agrega lógica adicional para validar la cláusula GROUP BY si es necesario
    return posicion;
}

function valida_having(posicion) {
    console.log(posicion + " -> HAVING : " + HAVING);
    // Agrega lógica adicional para validar la cláusula HAVING si es necesario
    return posicion;
}

function valida_join(posicion) {
    console.log(posicion + " -> JOIN : " + JOIN);
    // Agrega lógica adicional para validar la cláusula JOIN si es necesario
    return posicion;
}
